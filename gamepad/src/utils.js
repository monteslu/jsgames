...
export function getInput() {
  ...
  gamepads.forEach((gp) => {
    if (gp) {
      ...
      // xbox style buttons
      player.BUTTON_A = player.BUTTON_SOUTH;
      player.BUTTON_B = player.BUTTON_EAST;
      player.BUTTON_X = player.BUTTON_WEST;
      player.BUTTON_Y = player.BUTTON_NORTH;
      players.push(player);
    }
  });
  ...
  // xbox style buttons
  keyboardPlayer.BUTTON_A = keyboardPlayer.BUTTON_SOUTH;
  keyboardPlayer.BUTTON_B = keyboardPlayer.BUTTON_EAST;
  keyboardPlayer.BUTTON_X = keyboardPlayer.BUTTON_WEST;
  keyboardPlayer.BUTTON_Y = keyboardPlayer.BUTTON_NORTH;
  players.push(keyboardPlayer);
  return players;
}
