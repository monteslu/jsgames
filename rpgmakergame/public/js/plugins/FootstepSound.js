...
(function() {
    ...
    var footStepJson = {
        ...
        always     : {
            interval: 2,
            walk1   : {name: 'Footstep-high', volume: 90, pitch: 100, pan: 0},
            walk2   : {name: 'Footstep-low', volume: 90, pitch: 100, pan: 0},
            dash1   : {name: 'Footstep-high', volume: 90, pitch: 100, pan: 0},
            dash2   : {name: 'Footstep-low', volume: 90, pitch: 100, pan: 0},
        },
        // 梯子属性通過時の足音
        ladder     : {
            interval: 1,
