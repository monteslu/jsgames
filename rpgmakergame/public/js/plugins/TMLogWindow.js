...
(function() {
  ...
  globalThis.parameters = PluginManager.parameters('TMLogWindow');
  globalThis.logWindowX = +(parameters['logWindowX'] || 0);
  globalThis.logWindowY = +(parameters['logWindowY'] || 464);
  globalThis.logWindowWidth = +(parameters['logWindowWidth'] || 480);
  globalThis.logWindowLines = +(parameters['lines'] || 6);
  globalThis.logWindowLineHeight = +(parameters['lineHeight'] || 24);
  globalThis.logWindowPadding = +(parameters['padding'] || 10);
  globalThis.logWindowFontSize = +(parameters['fontSize'] || 20);
  globalThis.logWindowStartVisible = JSON.parse(parameters['startVisible']);
  globalThis.logWindowCollideOpacity = +(parameters['collideOpacity'] || 128);
  globalThis.logWindowMessageBusyHide = JSON.parse(parameters['messageBusyHide']);
  globalThis.logWindowEventBusyHide = JSON.parse(parameters['eventBusyHide']);
  globalThis.logWindowMaxLogs = +(parameters['maxLogs'] || 20);
  ...
  Game_Temp.prototype.dummyWindow = function() {
    if (!this._dummyWindow) this._dummyWindow = new Window_Base(0, 0, 64, 64);
