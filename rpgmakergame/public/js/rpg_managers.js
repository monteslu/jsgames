...
DataManager.loadDataFile = function(name, src) {
    ...
    xhr.onerror = this._mapLoader || function() {
        ...
        console.log("DataManager.loadDataFile:", DataManager._errorUrl)
    };
    window[name] = null;
    xhr.send();
};
...
SceneManager.catchException = function(e) {
    console.log("SceneManager.catchException e: ", e)
...
PluginManager._path         = '../public/js/plugins/';
...
PluginManager.loadScript = function(name) {
    ...
    console.log("PluginManager.loadScript: " + name)
    
    // // Read the plugin file content
    const pluginPath = join(__projectDirname, url);
